        ...
        <div className="hero my-20">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className='w-1/2'>
                    ...
                    <p className="py-6">
                        There are many variations of passages of lorem ipsum available. But the majority hace suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.
                    </p>
                    <p className="py-6">
